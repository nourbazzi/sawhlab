...
data = bfopen('ChannelWF 640,WF 561,WF 488_Seq0045.nd2');
...
for series = 1:NumSeries
    ...
    ImageStack488 = ImageStack(:,:,3:3:zst*NumChannels);
    ...
    saveas(gcf,['sequential2/488_Hyb' num2str(Hyb) '_FOV' num2str(series)])
    save( ['sequential2/488_' num2str(Hyb) '_' num2str(series) '.mat'],'ImageStack488');
